"use strict";
describe("Test de création d'un évènement", function () {
    beforeEach(function () {
        cy.request("POST", "http://localhost:3000/auth/login", {
            email: "coco@test.fr",
            password: "password"
        }).then(function (resp) {
            var _a = resp.body, user = _a.user, accessToken = _a.accessToken, refreshToken = _a.refreshToken;
    ...
    it("should create an event with valid values without hitting the real API", function () {
