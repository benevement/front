...
const html4 = `
<div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,Helvetica Neue,Arial;margin:0;
...
<p style="margin:0 0 16px;color:#334155">Ceci est un message court qui s'affiche dans une fenêtre modale.</p>
